...
CREATE DATABASE IF NOT EXISTS `db_todolist` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_todolist`;
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `status` enum('canceled','completed','new','inprogress') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'new',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
